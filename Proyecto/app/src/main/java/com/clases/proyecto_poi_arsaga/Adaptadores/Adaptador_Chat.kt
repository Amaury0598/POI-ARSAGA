...
class AdaptorChat(private val context: Chat_Grupal, private val listamensajes: MutableList<Mensaje>, private  val Tipo : Int) : RecyclerView.Adapter<AdaptorChat.ChatViewHolder>()  {
